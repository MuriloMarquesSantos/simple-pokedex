    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            ...
            case 4:
                ...
                pokemonGroup.forEach(function (pokemon) { return showPokemon(pokemon); });
                return [2 /*return*/];
        }
    });
}); };
var getPokemon = function (id) { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            ...
            case 2:
                pokemon = _a.sent();
                pokemonType = pokemon.types.map(function (typeContainer) {
                ...
                return [2 /*return*/, transformedPokemon];
        }
    });
}); };
...
var createFilters = function () {
    ...
    var selectFilter = document.querySelector(".typesFilter");
    selectFilter === null || selectFilter === void 0 ? void 0 : selectFilter.addEventListener("change", function () {
        var selectedIndex = selectFilter.selectedIndex;
        var selectedValue = selectFilter.options[selectedIndex].value;
